...
//            _fixture.MockBotClient.Verify(mock => mock.SendTextMessageAsync(
//                It.Is<ChatId>(_ => _.Identifier == chat1.Id),
//                It.Is<string>(_ => _ == "Please, input a message"), 
//                It.IsAny<ParseMode>(),
//                It.IsAny<IEnumerable<MessageEntity>>(),
//                It.IsAny<bool>(), 
//                It.IsAny<bool>(),
...
//            _fixture.MockBotClient.Verify(mock => mock.SendTextMessageAsync(
//                It.Is<ChatId>(_ => _.Identifier == chat1.Id),
//                It.Is<string>(_ => _ == "Pin a message?"), 
//                It.IsAny<ParseMode>(),
//                It.IsAny<IEnumerable<MessageEntity>>(),
//                It.IsAny<bool>(), 
//                It.IsAny<bool>(),
...
//            _fixture.MockBotClient.Verify(mock => mock.SendTextMessageAsync(
//                It.IsAny<ChatId>(),
//                It.Is<string>(_ => _ != Messages.Cancelled && _ != "Pin a message?" && _ != "Please, input a message" && _ != Messages.SelectChat), 
//                It.IsAny<ParseMode>(),
//                It.IsAny<IEnumerable<MessageEntity>>(),
//                It.IsAny<bool>(), 
//                It.IsAny<bool>(), 
...
//            _fixture.MockBotClient.Verify(mock => mock.SendTextMessageAsync(
//                It.Is<ChatId>(_ => _.Identifier == chat1.Id),
//                It.Is<string>(_ => _ == "Confirm sending?"), 
//                It.IsAny<ParseMode>(),
//                It.IsAny<IEnumerable<MessageEntity>>(),
//                It.IsAny<bool>(), 
//                It.IsAny<bool>(),
//                It.IsAny<int>(),
//                It.IsAny<bool?>(),
//                It.Is<IReplyMarkup>(m => KeyboardMarkupActionButtons(m, 2)), 
//                It.IsAny<CancellationToken>()),
//                Times.Once);
//            _fixture.MockBotClient.Verify(mock => mock.SendTextMessageAsync(
//                It.Is<ChatId>(_ => _.Identifier == chat1.Id),
...
//            _fixture.MockBotClient.Verify(mock => mock.SendTextMessageAsync(
//                It.IsAny<ChatId>(),
//                It.Is<string>(_ => _ != Messages.Cancelled && _ != "Confirm sending?" && _ != "Pin a message?" && _ != "Please, input a message" && _ != Messages.SelectChat),
//                It.IsAny<ParseMode>(),
//                It.IsAny<IEnumerable<MessageEntity>>(),
//                It.IsAny<bool>(), 
//                It.IsAny<bool>(), 
...
//            message = new Message { MessageId = 4, Chat = chat1, From = user1, Text = Messages.No };
//            _bot.RecieveMessage(message).Wait();

//            message = new Message { MessageId = 5, Chat = chat1, From = user1, Text = Messages.OK };
//            _bot.RecieveMessage(message).Wait();
...
//                Times.Once);
//            _fixture.MockBotClient.Verify(mock => mock.SendTextMessageAsync(
//                It.Is<ChatId>(_ => _.Identifier == chat3.Id),
//                It.Is<string>(_ => _ == "Text to post"), 
//                It.IsAny<ParseMode>(),
//                It.IsAny<IEnumerable<MessageEntity>>(),
//                It.IsAny<bool>(), 
//                It.IsAny<bool>(), 
...
//            _fixture.MockBotClient.Verify(mock => mock.SendTextMessageAsync(
//                It.IsAny<ChatId>(),
//                It.Is<string>(_ => _ != "Confirm sending?" && _ != "Pin a message?" && _ != "Please, input a message" && _ != Messages.SelectChat && _ != "Text to post"),
//                It.IsAny<ParseMode>(),
//                It.IsAny<IEnumerable<MessageEntity>>(),
//                It.IsAny<bool>(), 
//                It.IsAny<bool>(), 
...
//            _fixture.MockBotClient.Verify(mock => mock.SendTextMessageAsync(
//                It.Is<ChatId>(_ => _.Identifier == chat3.Id),
//                It.Is<string>(_ => _ == messageWithPhoto.Caption), 
//                It.IsAny<ParseMode>(),
//                It.IsAny<IEnumerable<MessageEntity>>(),
//                It.IsAny<bool>(),
//                It.IsAny<bool>(),
...
//                It.IsAny<CancellationToken>()),
//                Times.Never);
//            _fixture.MockBotClient.Verify(mock => mock.SendPhotoAsync(
//                It.Is<ChatId>(_ => _.Identifier == chat3.Id),   
//                It.Is<InputOnlineFile>(_ => _.FileId == photo[0].FileId), 
//                It.Is<string>(_ => _ == messageWithPhoto.Caption),
//                It.IsAny<ParseMode>(),
//                It.IsAny<IEnumerable<MessageEntity>>(),
//                It.IsAny<bool>(),
